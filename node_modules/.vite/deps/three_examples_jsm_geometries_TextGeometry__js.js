import { ExtrudeGeometry } from "./three.module-Cwro9b1P.js";
...
var TextGeometry = class extends ExtrudeGeometry {
	constructor(text, parameters = {}) {
		...
		if (font === void 0) super();
			...
			if (parameters.depth === void 0 && parameters.height !== void 0) console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead");
